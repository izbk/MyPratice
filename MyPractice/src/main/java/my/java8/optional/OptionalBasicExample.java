package my.java8.optional;

import java.util.Optional;

/**
 * Advantages of Java 8 Optional: Null checks are not required. No more
 * NullPointerException at run-time. We can develop clean and neat APIs. No more
 * Boiler plate code
 * 
 * @author F
 *
...
public class OptionalBasicExample {
	 ...
	 */
	public static void optionalMapFlapMapExample() {
	...
	public static void optionalOrElseExample() {
		Optional<String> gender = Optional.of("MALE");
		Optional<String> emptyGender = Optional.empty();
